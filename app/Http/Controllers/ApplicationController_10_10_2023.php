...
class ApplicationController extends Controller
{
    ...
    public function exportAadhaarOnly()
    {
        ...
        return response()->download($filename, "aadhar-applications.csv", $headers);
    ...
    public function exportRation()
    {
        ...
        return response()->download($filename, "ration-aadhaar-applications.csv", $headers);
    ...
    public function exportNodoc()
    {
        ...
        return response()->download($filename, "no-aadhaar-ration-applications.csv", $headers);
