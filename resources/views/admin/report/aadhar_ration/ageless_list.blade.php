				...
				<div class="main-content app-content">
					...
					<div class="main-container container-fluid">
						...
						<div class="breadcrumb-header justify-content-between row me-0 ms-0" >
							<div class="col-xl-3">
								<h4 class="content-title mb-2">Application Report(Age)</h4>
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">

										<li class="breadcrumb-item active" aria-current="page"><i class="side-menu__icon fe fe-user"> </i> Application Report(Age) - Ration Card & Aadhar Card</li>
									</ol>
								</nav>
							</div>
                                                ...
                                                <select class="form-select" id="age"
                                                                        ...
                                                                        aria-label="Floating label select example" required>
                                                                         <option value="">
                                                                           Select</option>
                                                                        <option value="0-30"
                                                                            @if (old('gender') === '0-30') selected @endif>
                                                                            Less Than 30</option>
                                                                        <option value="30-50"
                                                                            @if (old('gender') === '30-50') selected @endif>
                                                                            Between 30-50
                                                                        </option>
                                                                        <option value="50"
