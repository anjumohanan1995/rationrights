				...
				<div class="main-content app-content">
					...
					<div class="main-container container-fluid">
						...
						<div class="breadcrumb-header justify-content-between row me-0 ms-0" >
							<div class="col-xl-3">
								<h4 class="content-title mb-2">Application Report(District)</h4>
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">

										<li class="breadcrumb-item active" aria-current="page"><i class="side-menu__icon fe fe-user"> </i> - Application Report(District)- Ration Card & Aadhar Card</li>
									</ol>
								</nav>
							</div>
     ...
     $(document).ready(function(){
	        ...
	        buttons: [
             ...
             "ajax": {
			       	...
			       	"url": "{{route('getDistrictApplications')}}",
