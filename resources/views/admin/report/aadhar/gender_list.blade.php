							...
							<div class="col-xl-3">
								...
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page"><i class="side-menu__icon fe fe-user"> </i> - Application Report(Gender) - Aadhaar Only</li>
									</ol>
								</nav>
							</div>
     ...
     $(document).ready(function(){
	        ...
	        buttons: [
             ...
             "ajax": {
			       	...
			       	"url": "{{route('getAdhaarGenderApplications')}}",
