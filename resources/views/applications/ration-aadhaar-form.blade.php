                            ...
                            <div class="tab-content bg-white p-5" id="myTabContent">
                                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <textarea type="text" name="address" id="address" class="form-control" value="{{ old('address') }}" placeholder=""
                                                    required>{{ old('address') }}</textarea>
                                                <label for="address">Address (Home Address)<span
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" name="age" id="age"
                                                    value="{{ old('age') }}" placeholder="" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" name="ration" id="ration"
                                                    value="{{ old('ration') }}" placeholder="" required>
                                                <label for="ration">Ration Card Number <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div>
                                                ...
                                                <label>
                                                    <input type="radio" name="eligibility" value="Yes"
                                                        @if (old('eligibility') === 'Yes') checked @endif required>
                                                    Yes
                                                </label>
                                                <label>
                                                    <input type="radio" name="eligibility" value="No"
                                                        @if (old('eligibility') === 'No') checked @endif required>
                                                    No
                                                </label>
                                            </div>
                                        </div>
