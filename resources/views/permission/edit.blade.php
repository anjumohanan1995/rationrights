...
<div class="main-content app-content">
	...
	<div class="main-container container-fluid">
		...
		<div class="breadcrumb-header justify-content-between row me-0 ms-0 mb-3" >
			<div class="col-xl-3">
				<h4 class="content-title mb-2"> Edit Permission  </h4>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						 
						<li class="breadcrumb-item active" aria-current="page"><i class="side-menu__icon fe fe-box"> </i> - Edit Permission</li>
					</ol>
				</nav>
			</div>
		</div>
					...
					<div class="card">
							...
							<div class="card-body">
								...
								<form name="createForm" id="createForm" method="post" action="javascript:void(0)">
									...
									<div class="mb-4 main-content-label">Permission Detail</div>
									<div class="form-group">
										<div class="row">
											<div class="col-md-3"><label class="form-label">Permission</label></div>
											<div class="col-md-9"><input type="text" class="form-control" placeholder="Permission" name="name" value="{{$data['name']}}" />
												@error('name')
