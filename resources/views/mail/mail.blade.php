                ...
                <table role="presentation"
                    ...
                    <tr>
                        <td align="center" style="padding:40px 0 30px 0;background:#70bbd9;">
                            <img src="{{asset('img/ildm-img.png') }}" alt="" width="300"
                                style="height:auto;display:block;" />
                            {{-- <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('img/ildm-img.png'))) }}" alt="" width="300"
                                style="height:auto;display:block;" /> --}}
                            {{-- <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('img/ildm-img.png'))) }}" alt="" width="300"
                                style="height:auto;display:block;" /> --}}
                        </td>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        {{-- <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;"> <p>Dear Shibin biju ,</p></h1> --}}
                                        <p
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0;">
                                        ...
                                        <p
                                            style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                        <p>We have included your secret password, Please don't share your password with
                                            others.</p>
                                        </p>
                                        <p
                                            style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                        <p>If you have any questions or need assistance, feel free to contact our
                                            support team.</p>
                                        </p>
                                        <p
                                            style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                ...
                                <tr>
                                    <td style="padding:0;width:50%;" align="left">
                                        <p
                                            ...
                                            &reg;© Copyrights 2023 ILDM Developed by Kawika Technologies. All rights
                                            reserved.<br />
                                        </p>
                                    </td>
