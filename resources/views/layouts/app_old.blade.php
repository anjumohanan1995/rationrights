           ...
           <h6 class="mb-0 text-dark">&nbsp;</h6>
                        ...
                        <div class="slide-left disabled active is-expanded d-none" id="slide-left">
                         ...
                         @php
                            ...
                            @endif
                        @if(@$role == 'Staff')
                            <span class="sub-side-menu__label">{{\Auth::user()->name}}</span><br>
                            <span class="sub-side-menu__label">{{\Auth::user()->role}}</span>
                        ...
                        <ul class="side-menu open" style="margin-right: 0px;">
                            ...
                            @if (!empty($permission))
                                ...
                                @foreach (@$permission->permission as $permissions)
                                    @if (@$permissions == 'user-management' && @$role = 'Admin')
                                        <li class="slide {{ request()->is('user-management') || request()->is('roles') || request()->is('permissions') ? 'is-expanded' : ''  }}" >
                                            ...
                                            <ul class="slide-menu">
                                                @if (!empty($sub_permission) && in_array('users', $sub_permission))
                                                    <li class="sub-slide">
                                                ...
                                                @endif
                                                @if (!empty($sub_permission) && in_array('add-role', $sub_permission))
                                                    <li class="sub-slide ">
                                                ...
                                                @endif
                                                @if (!empty($sub_permission) && in_array('permission', $sub_permission))
                                                    <li class="sub-slide">
                                    ...
                                    @endif
                                    @if (@$permissions == 'Student Report' && @$role = 'Admin')
                                    <li class="slide">
                                        <a class="side-menu__item" data-bs-toggle="slide"
                                            href="{{ url('student-management') }}">
                                            <i class="side-menu__icon 	fa fa-bars"> </i>
                                            <span class="side-menu__label">Student Report</span>
                            ...
                            @if(@$role ='Staff')
                                    <li class="slide">
                                        <a class="side-menu__item" data-bs-toggle="slide"
                                            href="{{ url('set-date') }}">
                                            <i class="side-menu__icon far fa-clock"> </i>
                                            <span class="side-menu__label">Set Date</span>
                                    ...
                                    <li class="slide">
                                        ...
                                        href="{{ url('application-list') }}">
                                            <i class="side-menu__icon 	far fa-file"> </i>
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item" data-bs-toggle="slide"
                                            href="">
                                            <i class="side-menu__icon fa fa-trophy"> </i>
                                            <span class="side-menu__label">Ranking</span>

                                        </a>
                                    </li>
                                    <li class="slide">
                                        <a class="side-menu__item  {{ request()->is('gd-interview') ? 'active' : '' }}" data-bs-toggle="slide"
                                        href="{{ url('gd-interview') }}">
                                            <i class="side-menu__icon fa fa-users"> </i>
                                            <span class="side-menu__label">Group Discussion</span>

                                        </a>
                                    </li>
                                    <li class="slide">
                                        <a class="side-menu__item {{ request()->is('interview-schedule') ? 'active' : '' }}""  data-bs-toggle="slide"
                                        href="{{ url('interview-schedule') }}">
                                            <i class="side-menu__icon 	fas fa-book"> </i>
                                            <span class="side-menu__label">Interview</span>
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item" data-bs-toggle="slide"
                                            href="">
                                             <i class="side-menu__icon 	fa fa-clone"> </i>
